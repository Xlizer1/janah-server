...
class CategoryController {
    ...
    static async getCategoriesWithCounts(req, res) {
        try {
            ...
            const categories = await CategoryModel.getAllCategoriesWithProductCounts(includeEmpty);
    ...
    static async getCategory(req, res) {
        try {
            ...
            const categoryWithCount = await CategoryModel.getCategoryWithProductCount(category.id);
    ...
    static async searchCategories(req, res) {
        try {
            ...
            const categories = await CategoryModel.searchCategories(searchTerm.trim());
    ...
    static async updateCategory(req, res) {
        try {
            ...
            if (updateData.slug) {
                const slugExists = await CategoryModel.slugExists(updateData.slug, category_id);
                if (slugExists) {
                    throw new ConflictError('A category with this slug already exists');
                }
            }
            
            const updatedCategory = await CategoryModel.updateCategory(category_id, updateData);
